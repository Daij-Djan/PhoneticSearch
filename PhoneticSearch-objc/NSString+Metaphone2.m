...
@implementation NSString (Metaphone2)

- (NSString *)metaphone2Code {
    NSString *code = @"";
    NSInteger term_length = [self length];//we need -1. therefore not unsigned
    if (term_length == 0) {
        return code;
    }
...
//    NSArray *vowels = [[NSArray alloc] initWithObjects:@"a",@"e",@"i",@"o",@"u",nil];
    ...
    NSString *aWord = [self lowercaseString];
